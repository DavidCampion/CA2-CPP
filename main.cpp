        ...
        _In_ LPSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    AppendMenuW(Alter, MF_STRING, IDM_EDIT_AD1, L"&Red-Blue Filter (Additional Feature 1)"); // Copy this line to add
    AppendMenuW(Alter, MF_STRING, IDM_EDIT_AD2, L"&Black and White Filter (Additional Feature 2)"); // Copy this line to add
    AppendMenuW(Alter, MF_STRING, IDM_EDIT_AD3, L"&Mirror Image (Additional Feature 3)"); // Copy this line to add

    AppendMenuW(Alter, MF_SEPARATOR, 0, NULL);
    AppendMenuW(Alter, MF_STRING, IDM_GAMMA, L"&Gamma"); // Copy this line to add
    AppendMenuW(Alter, MF_STRING, IDM_EDIT_AF, L"&Circshift (Advanced Feature)"); // Copy this line to add
